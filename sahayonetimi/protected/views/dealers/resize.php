...
<div class="addLogoContent clearfix">
  <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	...
	$this->widget('ext.yii-jcrop.jCropWidget',array(
         'imageUrl'=>Yii::app()->baseUrl.'/resimler/dealers/'.$model->dealersID.'/'.$model->logo,
        'formElementX'=>'Dealers_cropX',
        'formElementY'=>'Dealers_cropY',
        'formElementWidth'=>'Dealers_cropW',
        'formElementHeight'=>'Dealers_cropH',
