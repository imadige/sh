...
<?PHP $this->renderPartial("items/displaymenu",array("id"=>4,'model'=>$model))?>
	...
	<div class="formcont clearfix">
       ...
       <div class="productDetail">
            ...
            <table>
                ...
                <td class="w2">:</td>
                <td class="w3 reduced"><?=number_format($model->reducedPrice,2).' '.ProductsController::getParams_("currency",$model->reduceCur)." + ".Yii::t('trans','KDV')?></td>
                </tr>
            </table>
            </div>
            <?PHP endif;?>
