...
<h1><?=Yii::t('trans','Müşteriler - Yönet')?></h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'columns'=>array(
		array(
			'type'=>'raw', 
			'name'=>'customerID',
			'value'=>'$data->customerID+CustomersController::getParams("dealercustomerplus")',
		...
		array(
			'type'=>'raw', 
			'name'=>'cgID',
			'value'=>'CustomersController::getCg($data->cgID)',
			'filter'=>CustomersController::getCgList(),
