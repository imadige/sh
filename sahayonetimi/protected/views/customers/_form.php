...
<div class="searcGroup">
    ...
    <div class="row">
		...
		<?php echo $form->dropDownList($model,'taxnotype',CustomersController::getParams("taxnoType"),array('style'=>'width:109px')); ?> <?php echo $form->textField($model,'taxno',array('maxlength'=>45,'style'=>'width:109px')); ?>
