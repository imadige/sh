...
function reportX(){
var data="<?=$array_?>";
   $.post("<?=Yii::app()->createUrl("reportskiyaslamalar/dealers_")?>",{data:data,basTar:$('#basTar').val(),bitTar:$('#bitTar').val(),raporlamacd:$('#raporlamacd').val(),cur:$('#cur').val()},function(data){
...
function siralaX(e){
var data="<?=$array_?>";
   $.post("<?=Yii::app()->createUrl("reportskiyaslamalar/dealers_")?>?desc="+e,{data:data},function(data){
      $('.reports_Ki').html(data);
...
function getirX(e){
var data="<?=$array_?>";
   $.post("<?=Yii::app()->createUrl("reportskiyaslamalar/dealers_")?>?bt="+e,{data:data},function(data){
      $('.reports_Ki').html(data);
