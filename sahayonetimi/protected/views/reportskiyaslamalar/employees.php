...
function raporla(){
	if(dataItem.length<1){
		alert("Lütfen Kullanıcı Belirtiniz.");
		...
		$('.reports_Ki').html('<div class="loading"><img src="<?=Yii::app()->baseUrl?>/images/loading.gif" /></div>');
		 $.post("<?=Yii::app()->createUrl("reportskiyaslamalar/employees_")?>",{data:data_},function(data){
