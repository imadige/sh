  			...
  			(
				'visit' => array
					(
						...
						'url'=>'Yii::app()->createUrl("visits/create",array("appointmentsID"=>$data->appointmentsID+AppointmentsController::getParams("appointmentsplus"),"customerdealersID"=>$data->customerdealersID+AppointmentsController::getParams("dealerplus"),"cdtype"=>$data->cdtype))',  
					)
			),
		),
	),
