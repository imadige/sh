...
<img id="image" src="<?=Yii::app()->createUrl("barcode/getbarcode")?>?number=S-<?=$model->problematicproductsID+ProblematicproductsController::getParams("problematicplus")?>&size=<?=$param?>" title="<?=Yii::t('trans','Barkod')?>" />
